...
public class encript {
    ...
    public static void main(String[] args) throws Exception {
        Paillier paillier = new Paillier(100);
        paillier.generateKeys();

        BigInteger numero1 = new BigInteger("7");
        BigInteger numero2 = new BigInteger("3");

        BigInteger c1,c2,c3;
        c1 = paillier.encrypt(numero1);
        c2 = paillier.encrypt(numero2);

        System.out.println("Numero 1: " + c2);
    }

    public static class Paillier
    {
        private final int modLength;                  // length in bits of the modulus n
        ...
        {
            // certainty with which primes are generated: 1-2^(-CERTAINTY)
            int CERTAINTY = 64;
